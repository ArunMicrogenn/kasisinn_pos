...
class Receipts extends CI_Controller {
    ...
    {      
        ...
        {
            $restname =strtoupper( $row['Name']);
            $addr = ucwords($row['address1']);
            $addr2 = ucwords($row['address2']);
        ...
        foreach ($results->result_array() as $rows)        
        {
            ...
            $RoundeOff=number_format($rows['RoundeOff'],2);
        ...
        $tbl.=<<<EOD
            <hr/>          
                <tr >  
            <td style="width:16%;"><span style="text-align:left">BillNo</span></td>
            <td style="width:4%;"><span style="text-align:left">:</span></td>
            <td style="width:30%;"><span style="text-align:right">$billno&nbsp;&nbsp;</span></td>
            <td style="width:16%;"><span style="text-align:left">Table</span></td>
            <td style="width:4%;"><span style="text-align:left">:</span></td>           
            <td style="width:30%;"><span style="text-align:right">$table</span></td>               
            </tr>
            <tr >
            <td  style="width:16%;"><span style="text-align:left">Date</span></td> 
            <td  style="width:4%;"><span style="text-align:left">:</span></td>
            <td  style="width:30%;"><span style="text-align:right">$accountdate&nbsp;&nbsp;</span></td>           
            <td  style="width:16%;"><span style="text-align:left">Time</span></td>
            <td  style="width:4%;"><span style="text-align:left">:</span></td>
            <td  style="width:30%;"><span style="text-align:right">$dateti</span></td>
            </tr>
            <tr nobr="true">
             <td  style="width:16%;"><span style="text-align:left">PAX</span></td>
             <td  style="width:4%;"><span style="text-align:left">:</span></td>
             <td  style="width:30%;"><span style="text-align:right">$pax&nbsp;&nbsp;</span></td>
             <td  style="width:16%;"><span style="text-align:left">Stw</span></td> 
             <td  style="width:4%;"><span style="text-align:left">:</span></td>
            <td  style="width:30%;"><span style="text-align:right">$stw</span></td>              
            </tr>   
           </table>
        EOD;
        $tbl.=<<<EOD
        ...
        <td style="width:60px;font-size:12px;font-weight:bold;">RATE</td>
        <td style="width:80px;font-size:12px;font-weight:bold;text-align:right;">AMOUNT</td>
        </tr>
        </table>
        EOD;
        $tbl.=<<<EOD
        ...
        <td style="width:65px;text-align:right;">$item_rate</td>
        <td style="width:80px;text-align:right;">$line_tot</td>
        </tr>
        EOD;
        ...
        $sql2="select sum(Amount) as Amount,almas.taxid,almas.taxtype from trans_reskotbilltax_det Tsdet
         ...
         { $head=$row2['taxtype'];
           $taxamt=number_format($row2['Amount'],2);  
            if($taxamt != 0.00){
        $tbl.=<<<EOD
    ...
    {      
        ...
        $tbl.=<<<EOD
            ...
            <tr nobr="true">
                ...
                <span style="font-size:16px;font-weight:bold">Settlement Receipt</span>$mm
        EOD;
             if($gstin)
             {
        $tbl.=<<<EOD
        ...
        <tr >
        <td style="width:140px;font-size:12px;font-weight:bold;">ITEM NAME</td>
        <td style="width:50px;font-size:12px;font-weight:bold;text-align:center;">QTY</td>
        <td style="width:60px;font-size:12px;font-weight:bold;text-align:center;">RATE</td>
        <td style="width:85px;font-size:12px;font-weight:bold;text-align:right;">AMOUNT</td>
        </tr>
        </table>
        EOD;
        $tbl.=<<<EOD
        ...
        <td></td>
        <td style="text-align:right;width:145px;">$subtot</td>
        <td style=""></td>
        </tr>
        EOD;
        $tbl.=<<<EOD
        ...
        <td></td>
        <td style="text-align:right;width:145px;">-$discnt</td>
        <td style=""></td>
        </tr>
        EOD;
        }
        ...
        <td style="">$head</td>
        <td></td>
        <td style="text-align:right;width:145px;">$taxamt</td>
        <td style=""></td>
        </tr>
        EOD;
         } 
        ...
        inner join Paymodepos pm on pm.Payid=mas.Paymentid where Billid='$ID' and isnull(mas.Cancel,0)=0";
        ...
        {            
            ...
            $tbl.=<<<EOD
            <tr nobr="true">
            <td colspan="2" style="font-size:14px;" >Paymode:$PayMode</td>
            <td colspan="2" style="text-align:left;font-weight:bold;font-size:14px;">Amount :$BillAmount</td>           
            </tr>
            EOD;
            $subtotal=$subtotal+$line_tot;
        }
