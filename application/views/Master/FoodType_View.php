                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Food Type</div>
                            </div>
                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="<?php echo scs_index ?>Master/Add_FoodType" id="addRow" class="btn btn-info">
                                    ...
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
										...
										{
										$sql="select * from Mas_posfoodtype ig 
										...
										?>
											<tr class="odd gradeX">
												...
												<td  class="center"><?php echo $row['Foodtype'];?>	</td>												
												<td class="center">
													<a href="<?php echo scs_index ?>Master/Add_FoodType/<?php echo $row['ftypeid'] ?>/UPDATE" class="btn btn-tbl-edit btn-xs">
