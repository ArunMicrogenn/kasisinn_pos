                ...
                <div class="page-bar">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form action="<?php echo scs_index; ?>MsSql/ItemSubGroup1" method="POST">
                            <input type="hidden" name="ID" id="ID" value="<?php echo @$ID; ?>">
                            <div class="card-body row">
                                <div class="col-lg-6 p-t-20"> 
                                    <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class = "mdl-textfield__input" type = "text" value="<?php echo @$Subgroupname2; ?>" name="itemsubgroup" id = "itemsubgroup" required/>
                                        <label class = "mdl-textfield__label">Item Sub Group1</label>
                                    </div>
                                </div>
                                <?php 
                                ...
                                ?>
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                        <input class="mdl-textfield__input" type="text" id="itemgroup" value="<?php echo @$Itemgroup; ?>" name="itemgroup" readonly tabIndex="-1">
                                ...
                                {  ?>
                                    ...
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                        ...
                                        <ul data-mdl-for="itemgroup" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                                        <?php 
                                        $sql="select * from itemgroup where companyid='".$_SESSION['MPOSCOMPANYID']."' and isnull(inactive,0)=0";                             
                                        $result=$this->db->query($sql);
                                        foreach ($result->result_array() as $row)
                                        {
                                        ?>
