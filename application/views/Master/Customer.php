            ...
            <div class="page-bar">
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="<?php echo scs_index; ?>MsSql/Customer" method="POST">
					    <input type="hidden" name="ID" id="ID" value="<?php echo @$ID; ?>">
                        <div class="card-body row">
                            <div class="col-lg-6 p-t-20"> 
                                <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                    <input class = "mdl-textfield__input" value="<?php echo @$Customer; ?>" type = "text" name="Customer" id = "Customer" required/>
                            ...
                            <div class="col-lg-6 p-t-20"> 
                                <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                    <input class = "mdl-textfield__input" value="<?php echo @$Mobile; ?>" type = "text" name="Mobile" id = "Mobile" required/>
                            ...
                            <div class="col-lg-6 p-t-20"> 
                                <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                    <input class = "mdl-textfield__input" value="<?php echo @$email; ?>" type = "email" name="Email" id = "Email" />
