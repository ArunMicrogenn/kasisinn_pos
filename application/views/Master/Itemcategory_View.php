                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>All Item Categorys</header>
                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="<?php echo scs_index ?>Master/Add_Itemcategory" id="addRow" class="btn btn-info">
                                    ...
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
										...
										{
										$sql="select * from Itemcategory ig 
										...
										?>
											<tr class="odd gradeX">
												...
												<td class="center">
													<a href="<?php echo scs_index ?>Master/Add_Itemcategory/<?php echo $row['itemcategoryid'] ?>/UPDATE" class="btn btn-tbl-edit btn-xs">
