                    ...
                    <div class="card-body ">
                        <div class="row p-b-20">
                            <div class="col-md-6 col-sm-6 col-6">
                                <div class="btn-group">
                                    <a href="<?php echo scs_index; ?>Master/Add_Customer" id="addRow" class="btn btn-info">
                        ...
                        <table class="table table-hover table-checkable order-column full-width" id="example4">
                            ...
                            {
                            $sql="select * from CustomerResturant ";
                            }
                            else{
                            $sql="select * from CustomerResturant em
                            ...
                            ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a href="<?php echo scs_index; ?>Master/Add_customer/<?php echo $row['Customerid'] ?>/UPDATE" class="btn btn-tbl-edit btn-xs">
