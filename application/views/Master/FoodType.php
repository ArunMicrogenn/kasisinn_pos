                     ...
                     <div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="<?php echo scs_index; ?>MsSql/FoodType" method="POST">
                                <input type="hidden" name="ID" id="ID" value="<?php echo @$ID; ?>">
								<div class="card-body row">
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" value="<?php echo @$Foodtype; ?>" name="foodtype" id = "foodtype" required/>
