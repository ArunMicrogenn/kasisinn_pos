                            ...
                            <div class="card-body ">
                                <div class="row p-b-20">
                                    <div class="col-md-6 col-sm-6 col-6">
                                        <div class="btn-group">
                                            <a href="<?php echo scs_index; ?>Master/Add_Taxtype" id="addRow" class="btn btn-info">
                                ...
                                <table class="table table-hover table-checkable order-column full-width" id="example4">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="start"> Company </th>
                                            <th class="start"> Tax Type </th>												
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="start"><?php echo $row['company'];?></td>
                                            <td  class="start"><?php echo $row['taxtype'];?>	</td>												
                                            <td class="center">
                                                <a href="<?php echo scs_index; ?>Master/Add_Taxtype/<?php echo $row['taxid'] ?>/UPDATE" class="btn btn-tbl-edit btn-xs">
