        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="">Table</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <form action="<?php echo scs_index; ?>MsSql/Table" method="POST">
					<input type="hidden" name="ID" id="ID" value="<?php echo @$ID; ?>">
                    <div class="card-body row">
                        <div class="col-lg-6 p-t-20"> 
                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <input class = "mdl-textfield__input" type = "text" value="<?php echo @$Tablename; ?>" name="tablename" id = "tablename" required/>
                                <label class = "mdl-textfield__label">Table</label>
                            </div>
                            </div>
                            <div class="col-lg-6 p-t-20"> 
